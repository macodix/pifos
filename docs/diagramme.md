...
|---------|-------|-----|----------|
| 0.01 | 2026-06-26 | macodix | Erstanlage: Klassen-, Komponenten-/Datenfluss-, Sequenz- und Zustandsdiagramm in Mermaid, abgeleitet aus `docs/01_konzept.md` und `docs/02_anforderungen.md`. |
</content>
