...
| 0.12 | 2026-07-01 | macodix | SIC-18 (Größengrenze beim Einlesen) gestrichen (Entscheidung Martin) — keine sinnvolle Grenze bestimmbar, im Vertrauensmodell bestimmt der Ersteller die Größe selbst; Nummer bleibt unbesetzt, Hinweis in 13.6 ergänzt. |
| 0.13 | 2026-07-01 | macodix | CAL-08 ergänzt: Aufrufer-Basisklasse lädt eine Konfiguration aus einer Datei im angegebenen Format und liefert ein Config-Objekt. |
| 0.14 | 2026-07-01 | macodix | Config-Laden von der Aufrufer-Basisklasse zu Config verschoben (Entscheidung Martin): CAL-08 zurückgenommen (letzte Nummer, entfällt ohne Lücke), neu KFG-10 (Config lädt aus einer Datei im angegebenen Format). |
| 0.15 | 2026-07-01 | macodix | CAL-08 neu belegt (Entscheidung Martin): Die Aufrufer-Basisklasse lädt die Konfiguration über eine Methode und hält sie als Instanzvariable bereit. |
</content>
</invoke>
