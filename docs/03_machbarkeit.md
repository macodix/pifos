...
|---------|-------|-----|----------|
| 1.0 | 2026-06-27 | Claude | Erstanlage und Abschluss: Machbarkeitsprüfung je Konzeptbaustein mit Einzelurteilen, Gesamturteil und Bedingungsliste, abgeleitet aus `docs/01_konzept.md` und `docs/02_anforderungen.md`; Inhaltsverzeichnis ergänzt. |
