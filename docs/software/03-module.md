...
| `resolve_action(name) -> type[Action]` | schlägt eine Aktionsklasse im Aktions-Unterpaket nach (`pifos.actions.<name>`); ist sie nicht auffindbar oder keine `Action`-Unterklasse, entsteht `ModuleError` |
